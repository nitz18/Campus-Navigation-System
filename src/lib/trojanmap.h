...
class TrojanMap {
 public:
  ...
  double CalculateDistance(const std::string &a_id, const std::string &b_id);
  ...
  // path.)
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Brute_Force_Iterative(
      std::vector<std::string> location_ids);
  
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Backtracking(
      std::vector<std::string> location_ids);

  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Brute_Force_Recursive(
      std::vector<std::string> location_ids);

 void TravellingTrojan_Brute_Force_Recursive_Aux(
...
std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Brute_Force_Recursive_Backtracking(
  std::vector<std::string> location_ids);

  void TravellingTrojan_Brute_Force_Recursive_Backtracking_Aux(
      std::string start, std::string curr_node, double curr_cost, 
  std::vector<std::string> &curr_path, double &min_cost, std::vector<std::string> &min_path, 
  std::vector<std::vector<std::string>> &paths, std::vector<std::string> &location_ids, 
  std::pair<double, std::vector<std::vector<std::string>>> &records);
  ...
  bool RecursiveCycleDetection(const std::string &currID,std::unordered_map<std::string,int> &seen,const std::string &parentID);
