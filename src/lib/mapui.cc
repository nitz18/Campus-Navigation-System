...
void MapUI::PrintMenu() {
  ...
  case '4':
  {
    ...
    auto start = std::chrono::high_resolution_clock::now();
    auto results = map.TravellingTrojan_Brute_Force_Iterative(locations);
    auto stop = std::chrono::high_resolution_clock::now();
    auto duration = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
    CreateAnimation(results.second, "output0_iterative.avi");
    menu = "*************************Results******************************\n";
    std::cout << menu;
    menu = "TravellingTrojan_Brute_Force_Iterative\n";
    std::cout << menu;
    ...
    menu = "**************************************************************\n"
           "You could find your animation at src/lib/output0_iterative.avi.          \n";
    std::cout << menu;
    std::cout << "Time taken by function: " << duration.count()/1000 << " ms" << std::endl << std::endl;
    ...
    std::cout << "Calculating ..." << std::endl;
    start = std::chrono::high_resolution_clock::now();
    results = map.TravellingTrojan_Brute_Force_Recursive(locations);
    stop = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
    CreateAnimation(results.second, "output0_recursive.avi");
    menu = "*************************Results******************************\n";
    std::cout << menu;
    menu = "TravellingTrojan_Brute_Force_Recursive\n";
    std::cout << menu;
    if (results.second.size() != 0) {
      for (auto x : results.second[results.second.size()-1]) std::cout << "\"" << x << "\",";
      std::cout << "\nThe distance of the path is:" << results.first << " miles" << std::endl;
    ...
    menu = "**************************************************************\n"
           "You could find your animation at src/lib/output0_recursive.avi.\n";
    std::cout << menu;
    std::cout << "Time taken by function: " << duration.count()/1000 << " ms" << std::endl << std::endl;

        std::cout << "Calculating ..." << std::endl;
    start = std::chrono::high_resolution_clock::now();
    results = map.TravellingTrojan_Brute_Force_Recursive_Backtracking(locations);
    stop = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
    CreateAnimation(results.second, "output0_recursive_backtracking.avi");
    menu = "*************************Results******************************\n";
    std::cout << menu;
    menu = "TravellingTrojan_Brute_Force_Recursive_Backtracking\n";
    std::cout << menu;
    if (results.second.size() != 0) {
      for (auto x : results.second[results.second.size()-1]) std::cout << "\"" << x << "\",";
      std::cout << "\nThe distance of the path is:" << results.first << " miles" << std::endl;
    ...
    menu = "**************************************************************\n"
           "You could find your animation at src/lib/output0_recursive_backtracking.avi.\n";
    std::cout << menu;
    std::cout << "Time taken by function: " << duration.count()/1000 << " ms" << std::endl << std::endl;
...
void MapUI::PlotPath(std::vector<std::string> &location_ids) {
  ...
  for (auto i = 1; i < int(location_ids.size()); i++) {
    ...
    cv::line(img, cv::Point(int(start.first), int(start.second)),
             cv::Point(int(end.first), int(end.second)), cv::Scalar(255, 0, 0),
             LINE_WIDTH);
  }
  cv::startWindowThread();
  cv::imshow("TrojanMap", img);
